...
class ChannelGroupRegistry(Registry[ChannelGroup]):
    ...
    def add_channel(self, group: int, name: str, instance: Primitive,
                    rate: float, track_change: bool = False) -> None:
    ...
    def add_enum_channel(self, group: int, name: str, enum_name: str,
                         rate: float, track_change: bool = False) -> None:
